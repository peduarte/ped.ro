...
Create a `stitches.config.ts` (or `.js`) file import the `createCss` function.
...
You can use the `media` config key to define the media queries of your system. This is useful for applying responsive styles, or for responsively applying variants.
