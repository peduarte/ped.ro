...
Here's a simplified theme, for the sake of brevity. For more complete themes, checkout the Modulz [design system config](https://github.com/radix-ui/design-system/blob/master/stitches.config.ts).
...
When doing do, variants are inferred.
