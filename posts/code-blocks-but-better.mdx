...
This part is where the code block features happen. Syntax, line, word highlighting and MDX component substitution.
...
This is the main rehype plugin. This is where we handle syntax, line and word highlighting. Inspired by [mdx-prism](https://github.com/j0lv3r4/mdx-prism).
...
This is a rehype utility for highlighting word.
...
Finally, this how I can use these features in mdx files.

### Using basic code block
...
For it to work, I need to add an `id` to the code block. Then, I need render a self closing `RegisterLink` component, providing the `id`, the `index` and the `href`.
...
I can use the `Preview` component to render a previer of that the code block is showing.
...
I spent months thinking about building a custom code block. No jokes. I was scared of how much work it would be and how long it'd take. I was worried about the maintenance debt.

But actually, it's really not as complex as it looks.

A lot of what's going here you're probably already familiar with if you use MDX component substitution.

It feels really good to have control over these code blocks. I spend a lot of time writing documentation for the [Modulz](https://modulz.app) products and I having access to these features really help me tell a better story.

I'm not planning on open sourcing this, or offering as a package. It's not really an "isolated" thing. A lot of it depends on the power of MDX and styling.
