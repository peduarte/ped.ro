...
I've been exploring ways to improve the code blocks on the [Stitches](https://stitches.dev) and [Radix](https://radix-ui.com) documentation sites.
...
It feels really good to have control over these code blocks. I spend a lot of time writing documentation for the [Modulz](https://modulz.app) products and having access to these features really help me tell a better story.
